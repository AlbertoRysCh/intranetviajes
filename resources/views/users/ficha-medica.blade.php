            ...
            <form action="{{ route('ficha-medica.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 gap-4 p-6  bg-white border border-gray-200 rounded-lg shadow">
                    ...
                    <div class="grid grid-cols-2">
                        ...
                        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-3" id="qpreuno"
                            style="display:none">
                            <div>
                        ...
                        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-3" id="qpredos"
                            style="display:none">
                            <div>
                        ...
                        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-3" id="qpretres"
                            style="display:none">
                            <div>
                        ...
                        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-3" id="qprecuatro"
                            style="display:none">
                            <div>
                    ...
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                        <div>
                            ...
                            <div class="mt-2.5">
                                <input type="text" name="hist_medic" id="hist_medic" autocomplete="given-name"
                                    value="{{ isset($healthSheet) ? $healthSheet->hist_medico : '' }}"
                                    class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="mt-2.5">
                                <input type="text" name="hist_salud_em" id="hist_salud_em"
                                    autocomplete="family-name"
                                    value="{{ isset($healthSheet) ? $healthSheet->hist_med_em : '' }}"
                                    class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                    </div>
